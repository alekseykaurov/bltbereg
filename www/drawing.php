...
//сохраняем алиас родителя $main_color в результат
// $result["main_color_type"] = $main_color_parent["alias"];
...
//получаем цвет или картинку $main_color
// if($result["main_color_type"]=="tablicza-czvetov-ral1"){
// 	$main_color_color = $modx->getTemplateVars(Array("cvet_RAL"), '*', $main_color_page["id"]);
// } else {
// 	$main_color_color = $modx->getTemplateVars(Array("option_image"), '*', $main_color_page["id"]);
// }
...
//сохраняем цвет или картинку $main_color в результат
// $result["main_color_color"] = $main_color_color[0]["value"];
...
// if($result["inside_color_type"]=="tablicza-czvetov-ral1"){
// 	$inside_color_color = $modx->getTemplateVars(Array("cvet_RAL"), '*', $inside_color_page["id"]);
// } else {
// 	$inside_color_color = $modx->getTemplateVars(Array("option_image"), '*', $inside_color_page["id"]);
// }
if ($result["inside_color_type"] == 'czvet'){
...
// if($result["outside_color_type"]=="tablicza-czvetov-ral1"){
// 	$outside_color_color = $modx->getTemplateVars(Array("cvet_RAL"), '*', $outside_color_page["id"]);
// } else {
// 	$outside_color_color = $modx->getTemplateVars(Array("option_image"), '*', $outside_color_page["id"]);
// }
if ($result["outside_color_type"] == 'czvet'){
...
if($inside_view==191 || $inside_view == 252 || $inside_view == 295){
...
if($outside_view==191 || $outside_view == 252 || $outside_view == 295){
