...
if($insert["main_lock"]!=null && $insert["main_lock"]!=""){
...
if($insert["add_lock"]!=null && $insert["add_lock"]!=""){
...
if($insert["glazok"]!=null && $insert["glazok"]!=""){
...
if($insert["dovodchik"]!=null && $insert["dovodchik"]!=""){
...
if($insert["zadvijka"]!=null && $insert["zadvijka"]!=""){
...
$text .= xlsWriteLabel(38,1,"0"); //противопожарность
...
$to = "bmihh@yandex.ru";
	...
	<body>
	  ...
	  <p style="">Ссылка на проект: <a href="http://blt-bereg.ru/konstruktor-dverej/?project='.$order["order_id"].'">http://blt-bereg.ru/dveri-na-zakaz/?project='.$order["order_id"].'</a></p>
	</body>
	</html>
	';
