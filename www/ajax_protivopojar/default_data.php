...
if($special_offer["parent"]==506 || $special_offer["parent"]==9){
	...
	$cena_steklopak = $modx->getTemplateVars(Array('cena_steklopak'), '*', $special);
	...
	if($specialTVs[16]["value"]!=""){
		$result['steklopaket_position']["value"] = $specialTVs[16]['value'];
	...
	if($specialTVs[18]["value"]!=""){
		$result['ruchka']['value'] = $specialTVs[18]['value'];
	}
	$result["SPECIAL"] = $specialTVs;
